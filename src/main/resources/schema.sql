...
-- ALTER TABLE `healmate`.`USER_ROLES`
--    DROP FOREIGN KEY `USER_ID_FK` ;
-- ALTER TABLE `healmate`.`USER_ROLES`
--    DROP FOREIGN KEY `ROLE_ID_FK` ;
-- ALTER TABLE `healmate`.`HOS_CHAINS`
--    DROP FOREIGN KEY `HOS_ID_FK` ;
-- ALTER TABLE `healmate`.`HOS_CHAINS`
--    DROP FOREIGN KEY `CHAIN_ID_FK` ;
-- CREATE USER TABLE
...
CREATE TABLE IF NOT EXISTS USER_ROLES (
                                          ...
                                          CONSTRAINT ROLE_ID_FK FOREIGN KEY (ROLE_ID) REFERENCES ROLE (ROLE_ID) ON DELETE RESTRICT ON UPDATE RESTRICT
);
